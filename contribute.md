...
**1.** Fork [this](https://github.com/riyajath-ahamed/lightroomhouse.git) repository.

**2.** Clone your forked copy of the project.

```
git clone https://github.com/<your_user_name>/lightroomhouse.git
```
...
```
git remote add upstream https://github.com/riyajath-ahamed/lightroomhouse.git
```
